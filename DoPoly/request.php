...
<html lang="ru">
  ...
  <body>
    ...
    <div class="container center mt-4">
      <h2>Заявка</h2><br>
      <form action="validation-form/reqch.php" method="post" enctype="multipart/form-data">
        <input type="text" class="form-control" name="type" id="type" placeholder="Введите тип заявки"><br>
        <input type="text" class="form-control" name="comment" id="comment" placeholder="Комментарий к заявке"><br>
