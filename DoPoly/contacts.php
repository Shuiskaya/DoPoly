    ...
    <div class="container">
      <header class="d-flex flex-wrap align-items-center justify-content-center justify-content-md-between py-3 mb-4 border-bottom">
        ...
        <ul class="nav col-12 col-md-auto mb-2 justify-content-center mb-md-0">
          ...
          <li><a href="contacts.php" class="nav-link px-4">Контакты</a></li>
        </ul>
    ...
    <div class="container">
      ...
      <div class="row">
        <?php
          ...
          $result = $mysql->query("SELECT * FROM `staff`");
          while ($staff = $result->fetch_assoc()) { ?>
            <div class="col-md-4">
              <h4><?php echo $staff['name']; ?></h4>
              <h6><?php echo $staff['job']; ?> общежития №<?php echo $staff['dorm']; ?></h6>
              <h6>Телефон: <?php echo $staff['phone']; ?></h6><br>
            </div>
            <?php
          }
        ?>
