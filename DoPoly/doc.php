...
<html lang="ru">
  ...
  <body>
    ...
    <div class="container center mt-4">
      <h2>Документ</h2><br>
      <form action="validation-form/docch.php" method="post" enctype="multipart/form-data">
        <input type="text" class="form-control" name="type" id="type" placeholder="Введите тип документа"><br>
